# DETENT claude code handoff
## DETENT — Claude Code Handoff Document
...
**Working title:** DETENT (may change before release)
...
| Backup | SQLite file export as .DETENT | Via share sheet |
...
| Document | Contents |
| --- | --- |
| DETENT PRD v0.4 | Full requirements, scope, layer specs |
...
| DETENT\_screen\_inventory | Every screen, every element, all behaviors |
| DETENT\_navigation\_map.mermaid | Full navigation diagram |
