# DETENT screen inventory
## Screen Inventory

## Overview

DETENT contains approximately 26 distinct screens across 5 sections. Most complexity is concentrated in the one-time gear setup layer. Daily field use touches 2-4 screens maximum.
...
See `DETENT_navigation_map.mermaid` for the full navigation diagram.
...
| Data & Backup | Export backup | Writes .DETENT file via share sheet |
