# DETENT Project Memory

## Project Status
- [project_DETENT_status.md](project_DETENT_status.md) — Full implementation status: data layer, ViewModels, and partially-started UI layer
