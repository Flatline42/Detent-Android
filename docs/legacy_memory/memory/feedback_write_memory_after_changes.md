---
name: Write memory after completing changes
description: Always update memory at the end of a session — don't skip the memory write step
type: feedback
---

Always write memory updates at the end of a session after completing implementation work. Do not skip it.
